...
export default () => (
  <DefaultPage domain="ihomepage.cn" templateName="zh-win-back-users">
    <Link href="https://web.ihomepage.cn?utm_source=win-back-users">
      <Heading as="h2">重返 iHomepage，发现新体验</Heading>
    </Link>
    ...
    <Text>
      我们非常感谢您曾经使用过
      iHomepage。然而，我们注意到您最近的使用情况变得不活跃，我们想知道，是什么原因导致您停止使用我们的软件呢？我们希望能改善您的体验，并为您提供更好的服务。
    </Text>
    <Text>
      请考虑重新使用
      iHomepage，探索最新的功能，我们相信，您会发现全新的体验和价值。
    </Text>
    <Text>期待与您再次见面!</Text>
